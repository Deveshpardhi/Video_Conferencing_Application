          ...
          <div className={styles.lobbyCard}>
            ...
            <div className={styles.lobbyForm}>
              <p className={styles.lobbyHint}>
                Pick a display name and check your camera preview before joining.
              </p>
...
/>
            ...
            <div className={styles.lobbyPreviewWrap}>
              <span className={styles.lobbyLiveBadge}>LIVE</span>
              <video ref={localVideoref} className={styles.lobbyPreview} autoPlay muted></video>
            </div>
          </div>
        </div>
      ) : (
